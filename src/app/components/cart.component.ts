            ...
            >
              ...
              <div class="flex-1">
                ...
                <div class="flex items-center space-x-2 mt-1">
                  ...
                  >
                  <span
                    *ngIf="item.originalPrice"
                    class="text-sm text-gray-400 line-through"
                    >PKR {{ item.originalPrice }}</span
                  >
                </div>
          ...
          <div class="space-y-2 mb-4">
            <div class="flex justify-between text-sm">
              <span class="text-gray-600"
                >Subtotal ({{ cartService.itemCount() }} items)</span
              >
            ...
            <div class="flex justify-between text-sm">
              ...
              <span class="font-medium">
                <span
                  *ngIf="cartService.getShippingCost() === 0"
                  class="text-healthcare-green"
                  >FREE</span
                >
                <span *ngIf="cartService.getShippingCost() > 0"
                  >PKR {{ cartService.getShippingCost() }}</span
                >
              </span>
            </div>
            <div
              *ngIf="
                cartService.subtotal() < 1000 && cartService.subtotal() > 0
              "
