          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center space-x-3">
              <img
                ...
                alt="Arizona Health Care Products"
                class="w-10 h-10"
              />
              <div>
            ...
            <div class="flex items-center space-x-4">
              <a
                href="/"
                class="text-gray-600 hover:text-medical-blue transition-colors"
              >
          ...
          <div class="bg-white rounded-xl p-6 shadow-lg">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <p class="text-2xl font-bold text-medical-navy">
          ...
          <div class="bg-white rounded-xl p-6 shadow-lg">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <p class="text-2xl font-bold text-medical-navy">
                  PKR {{ dashboardStats.totalRevenue.toLocaleString() }}
                </p>
              </div>
            </div>
          </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    <tr *ngFor="let order of filteredOrders">
                      <td
                        class="px-6 py-4 whitespace-nowrap text-sm font-medium text-medical-navy"
                      >
                        {{ order.id }}
                      </td>
