    ...
    >
      <div class="max-w-md w-full space-y-8">
        ...
        >
          <div class="space-y-4">
            ...
            <div>
              ...
              />
              <p
                *ngIf="registerData.confirmPassword && !passwordsMatch()"
          ...
          <div class="flex items-center">
            ...
            <label for="agreeTerms" class="ml-2 block text-sm text-gray-900">
              I agree to the
              <a href="#" class="text-medical-blue hover:text-medical-navy"
                >Terms of Service</a
              >
              and
              <a href="#" class="text-medical-blue hover:text-medical-navy"
        ...
        <div class="text-center text-sm text-gray-600">
          <p>
            By creating an account, you agree to receive order updates via SMS
            and email.
          </p>
        </div>
      </div>
