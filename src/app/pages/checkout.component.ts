          ...
          <div class="text-center mb-8">
            ...
            <div class="flex items-center justify-center space-x-4">
              <div class="flex items-center">
                <div class="w-8 h-8 bg-medical-blue text-white rounded-full flex items-center justify-center text-sm font-bold">1</div>
                <span class="ml-2 text-sm font-medium text-medical-blue">Shipping</span>
              </div>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
              <form (ngSubmit)="processOrder()" #checkoutForm="ngForm">
                ...
                <div class="bg-white rounded-xl p-6 shadow-lg mb-6">
                  <h2 class="text-xl font-bold text-medical-navy mb-6">Shipping Information</h2>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <select [(ngModel)]="shippingAddress.district" name="district" required
                              class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent">
                    ...
                    <div>
                      ...
                      <input type="text" [(ngModel)]="shippingAddress.postalCode" name="postalCode"
                             class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent">
                    </div>
                  </div>
                  ...
                  <div class="mb-4">
                    ...
                    <textarea [(ngModel)]="shippingAddress.deliveryInstructions" name="deliveryInstructions" rows="3"
                              placeholder="Special delivery instructions (e.g., gate code, landmarks)"
                              class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent"></textarea>
                  </div>
                </div>
                  ...
                  <div class="space-y-4">
                    ...
                    <div class="border border-gray-200 rounded-lg p-4">
                      <label class="flex items-center cursor-pointer">
                        <input type="radio" [(ngModel)]="paymentMethod.type" name="paymentType" value="cod"
                    ...
                    <div class="border border-gray-200 rounded-lg p-4">
                      <label class="flex items-center cursor-pointer">
                        <input type="radio" [(ngModel)]="paymentMethod.type" name="paymentType" value="jazzcash"
                               class="w-4 h-4 text-medical-blue focus:ring-medical-blue border-gray-300">
                        <div class="ml-3 flex-1">
                          <div class="flex items-center justify-between">
                          ...
                          <p class="text-sm text-gray-500 mt-1">Pay securely with JazzCash mobile wallet</p>
                        </div>
                      </label>
                    </div>
                    ...
                    <div class="border border-gray-200 rounded-lg p-4">
                      <label class="flex items-center cursor-pointer">
                        <input type="radio" [(ngModel)]="paymentMethod.type" name="paymentType" value="easypaisa"
                               class="w-4 h-4 text-medical-blue focus:ring-medical-blue border-gray-300">
                        <div class="ml-3 flex-1">
                          <div class="flex items-center justify-between">
                          ...
                          <p class="text-sm text-gray-500 mt-1">Pay securely with EasyPaisa mobile wallet</p>
                        </div>
                      </label>
                    </div>
                    ...
                    <div class="border border-gray-200 rounded-lg p-4">
                      <label class="flex items-center cursor-pointer">
                        <input type="radio" [(ngModel)]="paymentMethod.type" name="paymentType" value="bank_transfer"
                               class="w-4 h-4 text-medical-blue focus:ring-medical-blue border-gray-300">
                        <div class="ml-3 flex-1">
                          <div class="flex items-center justify-between">
                ...
                <!-- Order Notes -->
                <div class="bg-white rounded-xl p-6 shadow-lg mb-6">
                  <h2 class="text-xl font-bold text-medical-navy mb-4">Order Notes (Optional)</h2>
                  <textarea [(ngModel)]="orderNotes" name="orderNotes" rows="3"
            ...
            <div class="lg:col-span-1">
              <div class="bg-white rounded-xl p-6 shadow-lg sticky top-8">
                ...
                <div class="border-t border-gray-200 pt-4 space-y-2">
                  ...
                  <div class="flex justify-between text-sm">
                    ...
                    <span class="font-medium">
                      <span *ngIf="getShippingCost() === 0" class="text-healthcare-green">FREE</span>
                      <span *ngIf="getShippingCost() > 0">PKR {{getShippingCost()}}</span>
                    </span>
                  </div>
                ...
                <!-- Place Order Button -->
                <button (click)="processOrder()" [disabled]="!isFormValid()"
