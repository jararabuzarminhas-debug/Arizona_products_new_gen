          ...
          <div class="text-center mb-8">
            ...
            <div class="flex items-center justify-center space-x-4">
              <div class="flex items-center">
                <div class="w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold" [ngClass]="step() >= 1 ? 'bg-medical-blue text-white' : 'bg-gray-300 text-gray-600'">1</div>
                <span class="ml-2 text-sm font-medium" [ngClass]="step() >= 1 ? 'text-medical-blue' : 'text-gray-600'">Shipping</span>
              </div>
              <div class="w-8 h-0.5" [ngClass]="step() > 1 ? 'bg-medical-blue' : 'bg-gray-300'"></div>
              <div class="flex items-center">
                <div class="w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold" [ngClass]="step() >= 2 ? 'bg-medical-blue text-white' : 'bg-gray-300 text-gray-600'">2</div>
                <span class="ml-2 text-sm font-medium" [ngClass]="step() >= 2 ? 'text-medical-blue' : 'text-gray-600'">Payment</span>
              </div>
              <div class="w-8 h-0.5" [ngClass]="step() > 2 ? 'bg-medical-blue' : 'bg-gray-300'"></div>
              <div class="flex items-center">
                <div class="w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold" [ngClass]="step() >= 3 ? 'bg-medical-blue text-white' : 'bg-gray-300 text-gray-600'">3</div>
                <span class="ml-2 text-sm font-medium" [ngClass]="step() >= 3 ? 'text-medical-blue' : 'text-gray-600'">Review</span>
              </div>
            </div>
          </div>
              ...
              <div *ngIf="step() === 1" class="space-y-6">
                <div class="bg-white rounded-xl p-6 shadow-lg">
                  <div class="flex items-center justify-between mb-6">
                    ...
                    <div class="flex items-center space-x-3">
                      <select [(ngModel)]="selectedBookIndex" (change)="applyAddressFromBook()" class="px-3 py-2 border border-gray-200 rounded-lg text-sm" [disabled]="addressBook.length === 0">
                        <option value="-1">Address Book</option>
                        <option *ngFor="let a of addressBook; let i = index" [ngValue]="i">{{ a.firstName }} {{ a.lastName }} — {{ a.city }}</option>
                      </select>
                      <label class="flex items-center text-sm text-gray-600">
                        <input type="checkbox" [(ngModel)]="saveAddress" class="mr-2 h-4 w-4 text-medical-blue rounded" />
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                      ...
                      <input type="text" [(ngModel)]="shippingAddress.firstName" name="firstName" required class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent" />
                    </div>
                    <div>
                      <label class="block text-sm font-medium text-gray-700 mb-2">Last Name *</label>
                      <input type="text" [(ngModel)]="shippingAddress.lastName" name="lastName" required class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent" />
                    </div>
                  </div>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                      ...
                      <input type="tel" [(ngModel)]="shippingAddress.phone" name="phone" required placeholder="+92-XXX-XXXXXXX" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent" />
                    </div>
                    <div>
                      <label class="block text-sm font-medium text-gray-700 mb-2">Email Address *</label>
                      <input type="email" [(ngModel)]="shippingAddress.email" name="email" required class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent" />
                    </div>
                  </div>

                  <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Street Address *</label>
                    <input type="text" [(ngModel)]="shippingAddress.address" name="address" required placeholder="House/Flat number, Street name" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent" />
                  </div>

                  <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div>
                      <label class="block text-sm font-medium text-gray-700 mb-2">City *</label>
                      <input type="text" [(ngModel)]="shippingAddress.city" name="city" required class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent" />
                    </div>
                    <div>
                      <label class="block text-sm font-medium text-gray-700 mb-2">District *</label>
                      <select [(ngModel)]="shippingAddress.district" name="district" required class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent">
                    ...
                    <div>
                      ...
                      <input type="text" [(ngModel)]="shippingAddress.postalCode" name="postalCode" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent" />
                    </div>
                  </div>

                  <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Delivery Instructions (Optional)</label>
                    <textarea [(ngModel)]="shippingAddress.deliveryInstructions" name="deliveryInstructions" rows="3" placeholder="Special delivery instructions (e.g., gate code, landmarks)" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent"></textarea>
                  </div>
                </div>
                ...
                <div class="bg-white rounded-xl p-6 shadow-lg">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <label class="border border-gray-200 rounded-lg p-4 cursor-pointer hover:border-medical-blue transition-colors" [class.border-medical-blue]="deliveryMethod === 'home'">
                      <div class="flex items-center justify-between">
                        <div class="flex items-center">
                          <input type="radio" [(ngModel)]="deliveryMethod" name="deliveryMethod" value="home" class="w-4 h-4 text-medical-blue" />
                          <span class="ml-3 font-medium text-gray-900">Home delivery</span>
                        </div>
                        <span class="text-sm text-gray-500">1–2 days</span>
                      </div>
                      <div class="mt-2 text-sm text-gray-600">PKR {{ homeDeliveryCost() }}</div>
                    </label>

                    <label class="border border-gray-200 rounded-lg p-4 cursor-pointer hover:border-medical-blue transition-colors" [class.opacity-50]="!isMajorCity()" [class.cursor-not-allowed]="!isMajorCity()" [class.border-medical-blue]="deliveryMethod === 'express'">
                      <div class="flex items-center justify-between">
                        <div class="flex items-center">
                          <input type="radio" [(ngModel)]="deliveryMethod" name="deliveryMethod" value="express" class="w-4 h-4 text-medical-blue" [disabled]="!isMajorCity()" />
                          <span class="ml-3 font-medium text-gray-900">Express delivery</span>
                        </div>
                        <span class="text-sm text-gray-500">Same day</span>
                      </div>
                      <div class="mt-2 text-sm text-gray-600">PKR 500</div>
                      <div class="mt-1 text-xs text-gray-500">Available in major cities</div>
                    </label>

                    <label class="border border-gray-200 rounded-lg p-4 cursor-pointer hover:border-medical-blue transition-colors" [class.border-medical-blue]="deliveryMethod === 'pickup'">
                      <div class="flex items-center justify-between">
                        <div class="flex items-center">
                          <input type="radio" [(ngModel)]="deliveryMethod" name="deliveryMethod" value="pickup" class="w-4 h-4 text-medical-blue" />
                          <span class="ml-3 font-medium text-gray-900">Pickup from distributor</span>
                        </div>
                  ...
                  <div class="mt-6">
                    <h3 class="font-medium text-gray-900 mb-2">Preferred delivery time</h3>
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                      <label class="border border-gray-200 rounded-lg p-2 text-center cursor-pointer" [class.border-medical-blue]="deliverySlot === '9AM-12PM'">
                        <input type="radio" [(ngModel)]="deliverySlot" name="deliverySlot" value="9AM-12PM" class="hidden" />
                        9AM-12PM
                      </label>
                      <label class="border border-gray-200 rounded-lg p-2 text-center cursor-pointer" [class.border-medical-blue]="deliverySlot === '12PM-3PM'">
                        <input type="radio" [(ngModel)]="deliverySlot" name="deliverySlot" value="12PM-3PM" class="hidden" />
                        12PM-3PM
                      </label>
                      <label class="border border-gray-200 rounded-lg p-2 text-center cursor-pointer" [class.border-medical-blue]="deliverySlot === '3PM-6PM'">
                        <input type="radio" [(ngModel)]="deliverySlot" name="deliverySlot" value="3PM-6PM" class="hidden" />
                        3PM-6PM
                      </label>
                      <label class="border border-gray-200 rounded-lg p-2 text-center cursor-pointer" [class.border-medical-blue]="deliverySlot === '7PM-9PM'">
                        <input type="radio" [(ngModel)]="deliverySlot" name="deliverySlot" value="7PM-9PM" class="hidden" />
                        7PM-9PM
                      </label>
                    </div>
                  </div>
                  ...
                  <div class="mt-6 flex justify-end">
                    <button (click)="goToStep(2)" [disabled]="!isShippingValid()" class="bg-medical-blue text-white px-6 py-3 rounded-lg font-medium hover:bg-medical-navy transition-colors disabled:opacity-50">Continue to Payment</button>
                  </div>
                </div>
              </div>
              ...
              <div *ngIf="step() === 2" class="space-y-6">
                <div class="bg-white rounded-xl p-6 shadow-lg">
                  ...
                  <div class="space-y-4">
                    <label class="border border-gray-200 rounded-lg p-4 flex items-start cursor-pointer" [class.border-medical-blue]="paymentMethod.type === 'cod'">
                      ...
                      <div class="ml-3 flex-1">
                        <div class="flex items-center justify-between">
                          ...
                          <span class="text-sm text-gray-500">+ PKR 50 fee</span>
                        </div>
                        <p class="text-sm text-gray-500 mt-1">Phone confirmation required prior to dispatch</p>
                      </div>
                    </label>
                    ...
                    <label class="border border-gray-200 rounded-lg p-4 flex items-start cursor-pointer" [class.border-medical-blue]="paymentMethod.type === 'jazzcash'">
                      ...
                      <div class="ml-3 flex-1">
                        <div class="flex items-center justify-between">
                          ...
                          <span class="text-sm text-healthcare-green">Instant</span>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mt-3">
                          <input type="tel" [(ngModel)]="paymentDetails.jazzcash.mobile" placeholder="JazzCash Mobile Number" class="px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue" />
                          <input type="text" [(ngModel)]="paymentDetails.jazzcash.cnic" placeholder="CNIC (optional)" class="px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue" />
                          <input type="text" [(ngModel)]="paymentDetails.jazzcash.transactionId" placeholder="Transaction ID (auto if empty)" class="px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue" />
                        </div>
                      </div>
                    </label>
                    ...
                    <label class="border border-gray-200 rounded-lg p-4 flex items-start cursor-pointer" [class.border-medical-blue]="paymentMethod.type === 'easypaisa'">
                      ...
                      <div class="ml-3 flex-1">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mt-3">
                          <input type="tel" [(ngModel)]="paymentDetails.easypaisa.mobile" placeholder="EasyPaisa Mobile Number" class="px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue" />
                          <input type="text" [(ngModel)]="paymentDetails.easypaisa.cnic" placeholder="CNIC (optional)" class="px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue" />
                          <input type="text" [(ngModel)]="paymentDetails.easypaisa.transactionId" placeholder="Transaction ID (auto if empty)" class="px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue" />
                        </div>
                      </div>
                    </label>
                    ...
                    <label class="border border-gray-200 rounded-lg p-4 flex items-start cursor-pointer" [class.border-medical-blue]="paymentMethod.type === 'bank_transfer'">
                      ...
                      <div class="ml-3 flex-1">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3">
                          ...
                          <input type="text" [(ngModel)]="paymentDetails.bank.transactionId" placeholder="Transaction ID (after transfer)" class="px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue" />
                        </div>
                      </div>
                    </label>
                    ...
                    <label class="border border-gray-200 rounded-lg p-4 flex items-start cursor-pointer" [class.border-medical-blue]="paymentMethod.type === 'card'">
                      ...
                      <div class="ml-3 flex-1 w-full">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mt-3">
                          <input type="text" [(ngModel)]="paymentDetails.card.cardNumber" placeholder="Card Number" maxlength="19" class="px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue" />
                          <input type="text" [(ngModel)]="paymentDetails.card.expiry" placeholder="MM/YY" maxlength="5" class="px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue" />
                          <input type="password" [(ngModel)]="paymentDetails.card.cvc" placeholder="CVC" maxlength="4" class="px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue" />
                        </div>
                      </div>
                    </label>
                  </div>
                  ...
                  <div class="mt-6 flex justify-between">
                    <button (click)="goToStep(1)" class="border-2 border-medical-blue text-medical-blue px-6 py-3 rounded-lg font-medium hover:bg-medical-blue hover:text-white transition-colors">Back</button>
                    <button (click)="goToStep(3)" [disabled]="!isPaymentValid()" class="bg-medical-blue text-white px-6 py-3 rounded-lg font-medium hover:bg-medical-navy transition-colors disabled:opacity-50">Review Order</button>
                  </div>
                </div>
              </div>
                ...
                <div class="bg-white rounded-xl p-6 shadow-lg">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <p class="text-sm text-gray-700">{{ shippingAddress.firstName }} {{ shippingAddress.lastName }}</p>
                      <p class="text-sm text-gray-700">{{ shippingAddress.phone }} • {{ shippingAddress.email }}</p>
                      <p class="text-sm text-gray-700">{{ shippingAddress.address }}, {{ shippingAddress.city }}, {{ shippingAddress.district | titlecase }} {{ shippingAddress.postalCode }}</p>
                      <p class="text-sm text-gray-700" *ngIf="shippingAddress.deliveryInstructions">Note: {{ shippingAddress.deliveryInstructions }}</p>
                      <p class="text-sm text-gray-700 mt-2">Delivery: {{ deliveryLabel() }} • Slot: {{ deliverySlot }}</p>
                      <p class="text-sm text-gray-700">Expected delivery: {{ expectedDelivery() }}</p>
                    </div>
                    <div>
                  ...
                  <div class="mt-6 flex items-center">
                    <label class="flex items-center text-sm text-gray-700">
                      <input type="checkbox" [(ngModel)]="acceptTerms" class="h-4 w-4 text-medical-blue rounded mr-2" />
                      I agree to the terms and medical disclaimers
                    </label>
                  </div>

                  <div class="mt-6 flex justify-between">
                    <button (click)="goToStep(2)" class="border-2 border-medical-blue text-medical-blue px-6 py-3 rounded-lg font-medium hover:bg-medical-blue hover:text-white transition-colors">Back</button>
                    <button (click)="placeOrder()" [disabled]="!acceptTerms || placing()" class="bg-healthcare-orange text-white px-6 py-3 rounded-lg font-bold hover:bg-orange-600 transition-colors disabled:opacity-50">{{ placing() ? 'Placing...' : 'Place Order' }}</button>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="space-y-4 mb-6">
                  <div *ngFor="let item of cartService.items()" class="flex items-center space-x-3">
                    ...
                    <div class="flex-1">
                      ...
                      <p class="text-sm font-bold text-medical-navy">PKR {{ item.price * item.quantity }}</p>
                    </div>
                  </div>
                </div>
            ...
            <div class="bg-white rounded-xl p-8 shadow-lg text-center">
              ...
              <div class="mt-6 text-left">
                ...
                <div class="mt-4 border-t pt-3 text-sm">
                  ...
                  <div class="flex justify-between" *ngIf="placedOrder()?.codFee"><span>COD Fee</span><span>PKR {{ placedOrder()?.codFee }}</span></div>
