            ...
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-gray-600 mt-1">
                  Manage profile, orders, and addresses
                </p>
              </div>
              <button
                (click)="logout()"
            ...
            <div class="lg:col-span-2">
              ...
              >
                <div class="flex items-center justify-between mb-6">
                  <h2 class="text-2xl font-bold text-medical-navy">
                    Order History
                  </h2>
                  <button
                    (click)="reloadOrders()"
                    class="text-sm text-gray-600 hover:text-medical-blue"
                  >
                    Refresh
                  </button>
                </div>
                    ...
                    <div class="flex items-center justify-between">
                      ...
                      <div class="text-right">
                        ...
                        <div class="mt-2 flex items-center space-x-2">
                          ...
                          <button
                            (click)="reorder(order)"
                            class="text-sm bg-medical-blue text-white px-3 py-1 rounded hover:bg-medical-navy"
                          >
                            Reorder
                          </button>
                        </div>
              ...
              >
                <div class="flex items-center justify-between mb-6">
                  ...
                  <button
                    (click)="startAdd()"
                    class="bg-medical-blue text-white px-4 py-2 rounded-lg font-medium hover:bg-medical-navy"
                  >
                    Add Address
                  </button>
                </div>
                    ...
                    <div class="flex items-center justify-between">
                      ...
                      <div class="space-x-2">
                        ...
                        <button
                          ...
                          class="text-sm border px-3 py-1 rounded hover:bg-red-50 text-red-600"
                        >
                          Delete
                        </button>
                      </div>
                ...
                >
                  ...
                  >
                    ...
                    <div class="md:col-span-2 flex items-center space-x-2">
                      <button
                        type="submit"
                        class="bg-medical-blue text-white px-4 py-2 rounded-lg"
                      >
                        Save
                      </button>
                      <button
                ...
                <div class="space-y-3">
                  <label class="flex items-center"
                    ><input
                      ...
                      class="h-4 w-4 text-medical-blue rounded"
...
export class AccountComponent {
  ...
  tabs: {
    id: "orders" | "profile" | "addresses" | "settings";
    label: string;
  }[] = [
  ...
  downloadInvoice(order: StoredOrder): void {
    ...
    const rows = order.items
      .map(
        (i) =>
          `<tr><td>${i.name}</td><td style='text-align:center'>${i.quantity}</td><td style='text-align:right'>PKR ${i.price}</td><td style='text-align:right'>PKR ${i.price * i.quantity}</td></tr>`,
      )
      .join("");
    win.document.write(`
