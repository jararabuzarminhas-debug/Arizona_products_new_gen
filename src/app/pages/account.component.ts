          ...
          <div class="bg-white rounded-xl p-6 shadow-lg mb-8">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-gray-600 mt-2">Manage your account and track your orders</p>
              </div>
              <button (click)="logout()" 
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div class="bg-white rounded-xl p-6 shadow-lg">
                <nav class="space-y-2">
                  <button *ngFor="let tab of tabs" (click)="activeTab.set(tab.id)"
                          ...
                          [ngClass]="activeTab() === tab.id ? 'bg-medical-blue text-white' : 'text-gray-700'">
            ...
            <div class="lg:col-span-2">
                ...
                <form (ngSubmit)="updateProfile()" #profileForm="ngForm">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                      ...
                      <input type="tel" [(ngModel)]="profileData.phone" name="phone" required
                             class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue">
                    </div>
                  </div>
              ...
              <div *ngIf="activeTab() === 'orders'" class="bg-white rounded-xl p-6 shadow-lg">
                <h2 class="text-2xl font-bold text-medical-navy mb-6">Order History</h2>
                ...
                <div *ngIf="orders.length === 0" class="text-center py-12">
                  ...
                  <button routerLink="/shop" class="bg-medical-blue text-white px-6 py-2 rounded-lg font-medium hover:bg-medical-navy transition-colors">
                    Start Shopping
                  </button>
                </div>
                  ...
                  <div *ngFor="let order of orders" class="border border-gray-200 rounded-lg p-4">
                    <div class="flex items-center justify-between mb-3">
                      <div>
                        ...
                        <p class="text-sm text-gray-500">{{order.date | date}}</p>
                      </div>
              ...
              <div *ngIf="activeTab() === 'addresses'" class="bg-white rounded-xl p-6 shadow-lg">
                <h2 class="text-2xl font-bold text-medical-navy mb-6">Saved Addresses</h2>
              ...
              <div *ngIf="activeTab() === 'settings'" class="bg-white rounded-xl p-6 shadow-lg">
                <h2 class="text-2xl font-bold text-medical-navy mb-6">Account Settings</h2>
                
                <!-- Change Password -->
                <div class="mb-8">
                  <h3 class="text-lg font-bold text-medical-navy mb-4">Change Password</h3>
                  <form (ngSubmit)="changePassword()" #passwordForm="ngForm">
                    <div class="space-y-4 mb-4">
                      <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Current Password</label>
                        <input type="password" [(ngModel)]="passwordData.current" name="currentPassword" required
                               class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue">
                      </div>
                      <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">New Password</label>
                        <input type="password" [(ngModel)]="passwordData.new" name="newPassword" required minlength="6"
                               class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue">
                      </div>
                      <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Confirm New Password</label>
                        <input type="password" [(ngModel)]="passwordData.confirm" name="confirmPassword" required
                               class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue">
                      </div>
                    </div>
                ...
                <div>
                  <h3 class="text-lg font-bold text-medical-navy mb-4">Notification Preferences</h3>
                  <div class="space-y-3">
...
export class AccountComponent {
  ...
  async changePassword(): Promise<void> {
    ...
    try {
      const result = await this.authService.changePassword(this.passwordData.current, this.passwordData.new);
      if (result.success) {
