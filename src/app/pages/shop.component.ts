      ...
      <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto text-center">
          <h1 class="text-4xl lg:text-5xl font-bold font-medical mb-6">
            Healthcare Products Shop
          </h1>
          <p class="text-xl text-blue-100 leading-relaxed">
            Browse our complete range of FDA-approved healthcare products for
      ...
      <div class="container mx-auto px-4">
        ...
        >
          ...
          <div class="flex flex-wrap gap-2">
            <button
              class="px-4 py-2 bg-medical-blue text-white rounded-lg font-medium hover:bg-medical-navy transition-colors"
            >
              All Products
            </button>
            <button
              class="px-4 py-2 bg-white text-gray-700 border border-gray-200 rounded-lg font-medium hover:bg-gray-50 transition-colors"
            >
              Fever Relief
            </button>
            <button
          ...
          <div>
            <select
              class="px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent"
            >
    ...
    <section class="py-12">
      <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div
            class="product-card group hover:scale-105 transition-all duration-300"
          >
            <div class="relative mb-6">
              ...
              <!-- Available Badge -->
              <div
                class="absolute top-4 left-4 bg-healthcare-green text-white px-3 py-1 rounded-full text-sm font-bold"
              >
                Available Now
              </div>
              <!-- Discount Badge -->
              <div
                class="absolute top-4 right-4 bg-arizona-orange text-white px-3 py-1 rounded-full text-sm font-bold"
              >
                25% OFF
              </div>
              <!-- Quick View Button -->
              ...
              >
                <button
                  class="bg-white text-medical-navy px-6 py-2 rounded-lg font-bold hover:bg-gray-100 transition-colors"
                >
                  Quick View
                </button>
              </div>
            ...
            <div class="space-y-3">
              <div class="flex items-center space-x-2">
                <span
                  class="bg-cooling-100 text-cooling-700 px-2 py-1 rounded text-xs font-medium"
                  >Fever Relief</span
                >
                <span
                  class="bg-medical-blue/10 text-medical-blue px-2 py-1 rounded text-xs font-medium"
                  >FDA Approved</span
                >
              </div>

              <h3
                class="text-xl font-bold text-medical-navy group-hover:text-medical-blue transition-colors"
              >
                Bye Bye Fever Cooling Patches
              </h3>

              <p class="text-gray-600 text-sm">
                Instant cooling relief patches. Safe with medication, up to 8
                hours relief. Pack of 2 patches.
              </p>
              ...
              <div class="flex items-center justify-between">
                <div>
                  <span class="text-2xl font-bold text-medical-navy"
                    >PKR 299</span
                  >
          ...
          <div class="product-card opacity-75 relative">
            <div class="relative mb-6">
              <img
                ...
                alt="Pain Relief Gel"
                class="w-full h-64 object-cover rounded-lg filter grayscale"
              />
              <!-- Coming Soon Overlay -->
              <div
                class="absolute inset-0 bg-medical-navy/80 flex items-center justify-center"
              >
            ...
            <div class="space-y-3">
              <div class="flex items-center space-x-2">
                <span
                  class="bg-gray-200 text-gray-600 px-2 py-1 rounded text-xs font-medium"
              ...
              <h3 class="text-xl font-bold text-gray-600">
                Arizona Pain Relief Gel
              </h3>
              <p class="text-gray-500 text-sm">
                Fast-acting topical pain relief gel for muscle and joint pain.
                Natural ingredients with cooling effect.
              </p>
          ...
          <div class="product-card opacity-75 relative">
            ...
            <div class="space-y-3">
              ...
              <h3 class="text-xl font-bold text-gray-600">
                Arizona Kids Vitamin Drops
              </h3>
              <p class="text-gray-500 text-sm">
                Essential vitamins for growing children. Orange flavor, easy to
                administer drops for daily nutrition.
              </p>
          ...
          <div class="product-card opacity-75 relative">
            ...
            <div class="space-y-3">
              ...
              <h3 class="text-xl font-bold text-gray-600">
                Arizona Family First Aid Kit
              </h3>
              <p class="text-gray-500 text-sm">
                Complete first aid kit for home and travel. Contains essential
          ...
          <!-- Bundle Offer -->
          <div
            class="product-card border-2 border-healthcare-orange relative overflow-hidden"
          >
            <!-- Bundle Badge -->
            <div
              class="absolute top-0 right-0 bg-healthcare-orange text-white px-4 py-2 text-sm font-bold transform rotate-12 translate-x-4 -translate-y-2"
            >
              BUNDLE OFFER
            </div>
            ...
            <div class="relative mb-6">
              <img
                src="/api/placeholder/300/300"
                alt="Family Health Bundle"
                class="w-full h-64 object-cover rounded-lg"
              />
              <div
                class="absolute bottom-4 left-4 bg-white/90 backdrop-blur-sm rounded-lg p-3"
              >
            ...
            <div class="space-y-3">
              <div class="flex items-center space-x-2">
                <span
                  class="bg-healthcare-orange/10 text-healthcare-orange px-2 py-1 rounded text-xs font-medium"
                  >Bundle</span
                >
                <span
                  class="bg-medical-blue/10 text-medical-blue px-2 py-1 rounded text-xs font-medium"
              ...
              <h3 class="text-xl font-bold text-medical-navy">
                Family Health Bundle
              </h3>
              <p class="text-gray-600 text-sm">
                4x Bye Bye Fever patches for the whole family. Perfect for
              ...
              <div class="space-y-2">
                ...
                <div class="flex items-center justify-between">
                  <span class="text-lg font-bold text-medical-navy"
                    >Bundle price:</span
                  >
                  <span class="text-2xl font-bold text-healthcare-orange"
                    >PKR 897</span
                  >
                </div>
              </div>
          ...
          <div
            class="product-card border-2 border-dashed border-gray-300 flex items-center justify-center min-h-[400px]"
          >
            <div class="text-center text-gray-500">
              ...
              <p class="text-sm">
                We're constantly expanding our healthcare product range
              </p>
            </div>
          </div>
        </div>
